<cfoutput>
  ...
  <cfparam name="url.removeUI" default="false">
            ...
            <main class="mdl-layout__content">
              ...
              <div class="page-content">
                ...
                <div class="mdl-grid">
                  ...
                  <div id="page-content-left-container" class="mdl-cell mdl-cell--2-col mdl-cell--8-col-tablet mdl-cell--4-col-phone light"></div>
                  ...
                  <div id="page-content-right-container" class="mdl-cell mdl-cell--2-col mdl-cell--8-col-tablet mdl-cell--4-col-phone light"></div>
